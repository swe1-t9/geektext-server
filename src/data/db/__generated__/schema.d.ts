...
/**
 * AUTO-GENERATED FILE @ 2019-07-28 00:45:28 - DO NOT EDIT!
 *
 * This file was automatically generated by schemats v.3.0.3
 * $ schemats generate -c postgres://username:password@ec2-54-197-239-115.compute-1.amazonaws.com:5432/d4c914b7iatck1?ssl=true&sslfactory=org.postgresql.ssl.NonValidatingFactory -t authors -t books -t migrations -t migrations_lock -t payment_credentials -t reviews -t saved_cart_items -t saved_carts -t shipping_addresses -t shopping_cart_items -t shopping_carts -t sold_items -t users -s public
 *
 */
...
export namespace payment_credentialsFields {
  export type id = string;
  export type user_id = string;
  export type stripe_token = string;
  export type card_association = string;
  export type last_four_digits = number;
  export type created_at = Date | null;
}

export interface payment_credentials {
  id: payment_credentialsFields.id;
  user_id: payment_credentialsFields.user_id;
  stripe_token: payment_credentialsFields.stripe_token;
  card_association: payment_credentialsFields.card_association;
  last_four_digits: payment_credentialsFields.last_four_digits;
  created_at: payment_credentialsFields.created_at;
}
...
export namespace sold_itemsFields {
  export type id = string;
  export type user_id = string;
  export type book_id = string;
  export type amount = number;
...
export interface sold_items {
  id: sold_itemsFields.id;
  user_id: sold_itemsFields.user_id;
  book_id: sold_itemsFields.book_id;
  amount: sold_itemsFields.amount;
  created_at: sold_itemsFields.created_at;
}
